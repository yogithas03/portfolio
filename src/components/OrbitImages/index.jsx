...
function OrbitItem({ item, index, totalItems, path, itemSize, rotation, progress, fill, tiltX = 65 }) {
  ...
  return (
    ...
    >
      <div 
        style={{ 
          transform: `rotateZ(${-rotation}deg) rotateX(${-tiltX}deg)`,
...
export default function OrbitImages({
  ...
  starInnerRatio = 0.5,
  rotation = -8,
  tiltX = 65, // added tilt for 3D effect
  duration = 40,
  itemSize = 64,
  direction = 'normal',
  fill = true,
  ...
  return (
    <div
      ref={containerRef}
      className={`relative mx-auto ${className} perspective-[1200px]`}
      style={{
    ...
    >
      ...
      >
        <div
          ...
          style={{
            transform: `rotateX(${tiltX}deg) rotateZ(${rotation}deg)`,
            transformOrigin: 'center center',
            transformStyle: 'preserve-3d',
          }}
        >
